...
<form method="get" class="js-form-order-filtering">
    ...
    <div class="manage-toobar d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('admin.order.abandoned')); ?>"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group mb-0">
                    <input type="text" class="form-control" value="<?php echo e($id); ?>" name="id" placeholder="<?php _e("Order ID");?>">
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group mb-0">
                    <select name="orderStatus" class="selectpicker" data-width="100%">
                        ...
                        <option value="" <?php if($orderStatus == ''): ?> selected="selected" <?php endif; ?>>
                            <?php _e('All'); ?>
                        </option>

                        <option value="new" <?php if($orderStatus == 'new'): ?> selected="selected" <?php endif; ?>>
                            <?php _e('New'); ?>
                        </option>

                        <option value="pending" <?php if($orderStatus == 'pending'): ?> selected="selected" <?php endif; ?>>
                            <?php _e('Pending'); ?>
                        </option>

                        <option value="completed" <?php if($orderStatus == 'completed'): ?> selected="selected" <?php endif; ?>>
                            <?php _e('Completed'); ?>
                        </option>
                    </select>
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-0">
                        ...
                        <input type="text" class="form-control" value="<?php echo e($minDate); ?>" name="minDate" id="js-order-filter-date-from" placeholder="<?php _e("Set the orders from date");?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-0">
                        ...
                        <input type="text" class="form-control" value="<?php echo e($maxDate); ?>" name="maxDate" id="js-order-filter-date-to" placeholder="<?php _e("Set the orders to date");?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-0">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><?php echo e(get_currency_symbol()); ?></span>
                        </div>
                        <input type="number" class="form-control" value="<?php echo e($minPrice); ?>" name="minPrice" placeholder="<?php _e("Show the order with minimum amount");?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group mb-0">
                        ...
                        <input type="number" class="form-control" value="<?php echo e($maxPrice); ?>" name="maxPrice" placeholder="<?php _e("Show the order with maximum amount");?>">
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="hidden" class="js-orders-search-product-keyword" name="productKeyword" value="<?php echo e($productKeyword); ?>" />
                        <input type="hidden" class="js-orders-search-product" name="productId" value="<?php echo e($productId); ?>" />
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-0">
                        ...
                        <select name="isPaid" class="selectpicker" data-width="100%">
                            ...
                            <option value="" <?php if($isPaid == ''): ?> selected="selected" <?php endif; ?>>
                                <?php _e('All'); ?>
                            </option>

                            <option value="1" <?php if($isPaid == '1'): ?> selected="selected" <?php endif; ?>>
                                <?php _e('Paid'); ?>
                            </option>

                            <option value="0" <?php if($isPaid == '0'): ?> selected="selected" <?php endif; ?>>
                                <?php _e('Unpaid'); ?>
                            </option>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo e($keyword); ?>" name="keyword" placeholder="<?php _e("Free search by phone, name, email etc...");?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <a href="<?php echo e(route('admin.order.index')); ?>" class="btn btn-outline-primary">
                        <?php _e("Reset filter"); ?>
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\Users\Asus\OneDrive\Desktop\LIKUS_mapa\LikusProjekt_plus_Microweber\Likus\Likus\Frontend\src\MicroweberPackages\Order/resources/views/admin/orders/partials/order_filtering.blade.php ENDPATH**/ ?>