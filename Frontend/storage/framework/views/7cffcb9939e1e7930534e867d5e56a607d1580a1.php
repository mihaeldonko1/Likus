    ...
    <div class="card-body pt-3">
        ...
        <div class="tab-content py-3">
                ...
                <div class="module-live-edit-settings module-blog-settings">
                    <?php if($pages->count() == 0): ?>
                        <div class="alert alert-warning">
                            <?php echo e(_e('You don\'t have any blog pages.')); ?>

                            <br />
                            <?php echo e(_e('Please, create a blog page from admin panel to continue.')); ?>
                        ...
                        <div class="form-row row js-filtering-settings-holder" style="display: none;">
                            ...
                            <script type="text/javascript">
                                ...
                                function loadFilteringCustomFieldsTable() {
                                    ...
                                    $.post("<?php echo e($getCustomFieldsTableRoute); ?>", {
                                        ...
                                        <div class="js-filterting-custom-fields-settings" <?php if (!get_option('filtering_by_custom_fields', $moduleId)): ?>style="display:none"<?php endif; ?>>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="filtering_when" option-group="<?php echo $moduleId;?>" class="mw_option_field form-control">
                                                    <option <?php if (get_option('filtering_when', $moduleId) == 'automatically'): ?> selected="selected" <?php endif; ?> value="automatically"><?php echo e(_e("Automatically")); ?></option>
                                                    <option <?php if (get_option('filtering_when', $moduleId) == 'apply_button'): ?> selected="selected" <?php endif; ?> value="apply_button"><?php echo e(_e("Apply Button")); ?></option>
                                                </select>
                                            </div>
            ...
            <div class="tab-pane fade" id="templates">
                <module type="admin/modules/templates" parent-module="blog" parent-module-id="<?php echo e($moduleId); ?>" />
            </div>
        </div>

    </div>
</div>
<?php /**PATH C:\Users\Asus\OneDrive\Desktop\LIKUS_mapa\LikusProjekt_plus_Microweber\Likus\Likus\Frontend\src\MicroweberPackages\Blog\resources\views\/admin/live_edit.blade.php ENDPATH**/ ?>