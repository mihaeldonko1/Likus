            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php if(isset($data['data']['attributes']['Profilna_slika']['data']['attributes']['url'])): ?>
                        <img src="http://localhost:1337<?php echo e($data['data']['attributes']['Profilna_slika']['data']['attributes']['url']); ?>" style="width: 80%; margin-bottom: 10px; border-radius: 20px">
                    <?php else: ?>
                ...
                <div class="col-md-12 text-center">
                    <div class="row">
                        <span style="font-size: 2.5em; color: #e89443;  margin-bottom: 2px; text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2);"><?php echo e($data['data']['attributes']['Ime']); ?> <?php echo e($data['data']['attributes']['Priimek']); ?></span><br>
                        <span style="font-size: 1.2em;  margin-bottom: 2px">Datum rojstva: <i><?php echo e(date('d-m-Y', strtotime($data['data']['attributes']['Rojstni_dan']))); ?> </i></span>
                        <span style="font-size: 1.2em;  margin-bottom: 2px">Spol:  <i><?php echo e($data['data']['attributes']['Spol']); ?> </i></span><br>
                        <span style="font-size: 1.2em;  margin-bottom: 2px">Starost:  <i><?php echo e($yearsDifference); ?> </i></span><br>
                    </div>
                </div>
            </div>
    </div>
