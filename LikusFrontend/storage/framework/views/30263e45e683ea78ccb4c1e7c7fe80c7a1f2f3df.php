    ...
    <div class="card-body" id="">
        ...
        <div class="toolbar row mb-3">
            <div class="col-12 text-center text-sm-left">
                ...
                <small class="text-muted"><?php _e("List of all notifications of your website."); ?>
                </small>
            </div>
        ...
        <div class="timeline js-all-notifications">
            ...
            <div class="row timeline-event mw-ui-admin-notif-item-<?php echo e($notification['id']); ?>" onclick="mw.notif_item_read('<?php echo e($notification['id']); ?>')">
                <div class="col pr-0 timeline-line <?php if ($countIterations == $allNotificationsCount): ?>timeline-line-last<?php endif; ?>">
                    <div class="custom-control custom-checkbox d-inline-block">
                        <input type="checkbox" class="custom-control-input js-checked-checkbox"
                               id="notif-<?php echo e($notification['id']); ?>" value="<?php echo e($notification['id']); ?>"
                               name="checked[<?php echo e($notification['id']); ?>]">
                        <label class="custom-control-label" for="notif-<?php echo e($notification['id']); ?>"></label>
                    </div>
            ...
            <?php echo e($notifications_model->withQueryString()->links()); ?>
...
<?php /**PATH C:\Users\mihad\OneDrive\Namizje\Praktikum3\Likus\LikusFrontend\src\MicroweberPackages\Notification/resources/views/notifications/index.blade.php ENDPATH**/ ?>