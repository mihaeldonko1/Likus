...
} elseif ($_instance->childHasBeenRendered('QnFqJxi')) {
    $componentId = $_instance->getRenderedChildComponentId('QnFqJxi');
    $componentTag = $_instance->getRenderedChildComponentTagName('QnFqJxi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QnFqJxi');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('QnFqJxi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\Users\mihad\OneDrive\Namizje\Praktikum3\Likus\LikusFrontend\src\MicroweberPackages\Admin/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>