...
} elseif ($_instance->childHasBeenRendered('4V5u25a')) {
    $componentId = $_instance->getRenderedChildComponentId('4V5u25a');
    $componentTag = $_instance->getRenderedChildComponentTagName('4V5u25a');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4V5u25a');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('4V5u25a', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
