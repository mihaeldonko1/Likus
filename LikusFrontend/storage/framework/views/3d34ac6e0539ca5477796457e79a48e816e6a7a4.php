        ...
        <div class="row">
            ...
            <a href="knjiga/<?php echo e($item['id']); ?>">
                <div class="card text-center">
                    ...
                    <img src="http://localhost:1337<?php echo e($item['attributes']['Slika_platnice']['data']['attributes']['url']); ?>" class="card-img-top mx-auto d-block mt-3 card-img" style="height:300px !important">
                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\LIKUS_mapa\LikusProjekt_plus_Microweber\Likus\Likus\LikusFrontend\resources\views/books.blade.php ENDPATH**/ ?>