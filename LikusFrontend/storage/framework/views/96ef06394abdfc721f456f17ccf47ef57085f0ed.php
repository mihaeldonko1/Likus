...
} elseif ($_instance->childHasBeenRendered('NiAShTA')) {
    $componentId = $_instance->getRenderedChildComponentId('NiAShTA');
    $componentTag = $_instance->getRenderedChildComponentTagName('NiAShTA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NiAShTA');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('NiAShTA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\Users\mihad\OneDrive\Namizje\microweber-master (3)\src\MicroweberPackages\Admin/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>