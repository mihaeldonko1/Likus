            ...
            <div class="row">
                <div class="col-md-12">
                    <?php if(isset($data['data']['attributes']['Slika_platnice']['data']['attributes']['url'])): ?>
                        <img src="http://localhost:1337<?php echo e($data['data']['attributes']['Slika_platnice']['data']['attributes']['url']); ?>" class="card-img-top mx-auto d-block" style="width: 60%; margin-bottom: 15px;">
                    <?php else: ?>
