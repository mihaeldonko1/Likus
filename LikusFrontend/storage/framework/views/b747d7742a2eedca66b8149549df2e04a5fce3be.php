...
} elseif ($_instance->childHasBeenRendered('tA935wS')) {
    $componentId = $_instance->getRenderedChildComponentId('tA935wS');
    $componentTag = $_instance->getRenderedChildComponentTagName('tA935wS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tA935wS');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('tA935wS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
