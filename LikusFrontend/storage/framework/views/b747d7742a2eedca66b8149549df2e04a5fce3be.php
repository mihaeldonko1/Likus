...
} elseif ($_instance->childHasBeenRendered('XkQVXrX')) {
    $componentId = $_instance->getRenderedChildComponentId('XkQVXrX');
    $componentTag = $_instance->getRenderedChildComponentTagName('XkQVXrX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XkQVXrX');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('XkQVXrX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
