                ...
                <div class="card d-flex align-items-center justify-content-center">
                    <div class="card-body text-center">
                        <?php if($val['attributes']['Stevilka_knjige'] < 69): ?>
                            <img src="/resources/img/icons/knjige/<?php echo e($val['attributes']['Stevilka_knjige']); ?>-knjiga.jpg" class="card-img-top mx-auto d-block mt-3 card-img" style="height:300px !important">
                        <?php else: ?>
