...
} elseif ($_instance->childHasBeenRendered('a8UoZpH')) {
    $componentId = $_instance->getRenderedChildComponentId('a8UoZpH');
    $componentTag = $_instance->getRenderedChildComponentTagName('a8UoZpH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('a8UoZpH');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('a8UoZpH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\Users\Miha\Desktop\Praktikum2\Likus\LikusFrontend\src\MicroweberPackages\Admin/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>