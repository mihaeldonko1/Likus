...
} elseif ($_instance->childHasBeenRendered('7ja6gIy')) {
    $componentId = $_instance->getRenderedChildComponentId('7ja6gIy');
    $componentTag = $_instance->getRenderedChildComponentTagName('7ja6gIy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7ja6gIy');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('7ja6gIy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
