(function () {
    ...
    mw.settings = {
        ...
        template_url: 'http://127.0.0.1:8000/userfiles/templates/new-world/',
    ...
    const Ziggy = {"url":"http:\/\/127.0.0.1:8000","port":8000,"defaults":{},"routes":{"admin.user.index":{"uri":"mw_admin\/user","methods":["GET","HEAD"]},"admin.user.store":{"uri":"mw_admin\/user","methods":["POST"]},"admin.user.update":{"uri":"mw_admin\/user\/{user}","methods":["PUT","PATCH"]},"admin.user.destroy":{"uri":"mw_admin\/user\/{user}","methods":["DELETE"]},"logout":{"uri":"logout","methods":["GET","HEAD"]},"logout.submit":{"uri":"logout","methods":["POST"]},"verification.verify":{"uri":"email\/verify\/{id}\/{hash}","methods":["GET","HEAD"]},"verification.resend":{"uri":"email\/verify-resend\/{id}\/{hash}","methods":["GET","HEAD"]},"verification.send":{"uri":"email\/verify-resend\/{id}\/{hash}","methods":["POST"]},"password.request":{"uri":"forgot-password","methods":["GET","HEAD"]},"password.email":{"uri":"forgot-password","methods":["POST"]},"password.reset":{"uri":"reset-password\/{token}","methods":["GET","HEAD"]},"password.update":{"uri":"reset-password","methods":["POST"]},"api.users.export_my_data":{"uri":"api\/users\/export_my_data","methods":["GET","HEAD"]},"admin.login":{"uri":"mw_admin\/login","methods":["GET","HEAD"]},"api.user.login":{"uri":"api\/user\/login","methods":["POST"]},"api.user.logout":{"uri":"api\/user\/logout","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.user.register":{"uri":"api\/user\/register","methods":["POST"]},"api.user.password.email":{"uri":"api\/user\/forgot-password","methods":["POST"]},"api.user.password.update":{"uri":"api\/user\/reset-password","methods":["POST"]},"api.user.profile.update":{"uri":"api\/user\/profile-update","methods":["POST"]},"api.api.logout":{"uri":"api\/logout","methods":["GET","HEAD"]},"api.user.index":{"uri":"api\/user","methods":["GET","HEAD"]},"api.user.store":{"uri":"api\/user","methods":["POST"]},"api.user.show":{"uri":"api\/user\/{user}","methods":["GET","HEAD"]},"api.user.update":{"uri":"api\/user\/{user}","methods":["PUT","PATCH"]},"api.user.destroy":{"uri":"api\/user\/{user}","methods":["DELETE"]},"api.content.get_admin_js_tree_json":{"uri":"api\/content\/get_admin_js_tree_json","methods":["GET","HEAD"]},"api.content.store":{"uri":"api\/content","methods":["POST"]},"api.content.save_edit":{"uri":"api\/save_edit","methods":["POST"]},"api.content.set_published":{"uri":"api\/content\/set_published","methods":["POST"]},"api.content.set_unpublished":{"uri":"api\/content\/set_unpublished","methods":["POST"]},"api.content.reorder":{"uri":"api\/content\/reorder","methods":["POST"]},"api.content.reset_edit":{"uri":"api\/content\/reset_edit","methods":["POST"]},"api.content.reset_modules_settings":{"uri":"api\/content\/reset_modules_settings","methods":["POST"]},"api.content.bulk_assign":{"uri":"api\/content\/bulk_assign","methods":["POST"]},"api.content.copy":{"uri":"api\/content\/copy","methods":["POST"]},"api.content.related.add":{"uri":"api\/content\/related_content\/add","methods":["POST"]},"api.content.related.remove":{"uri":"api\/content\/related_content\/remove","methods":["POST"]},"api.content.related.reorder":{"uri":"api\/content\/related_content\/reorder","methods":["POST"]},"api.content.redirect_to_content":{"uri":"api\/content\/redirect_to_content","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.content.delete":{"uri":"api\/content\/delete","methods":["POST"]},"api.content.get_link_admin":{"uri":"api\/content\/get_link_admin","methods":["GET","HEAD"]},"admin.content.index":{"uri":"mw_admin\/content","methods":["GET","HEAD"]},"admin.content.create":{"uri":"mw_admin\/content\/create","methods":["GET","HEAD"]},"admin.content.store":{"uri":"mw_admin\/content","methods":["POST"]},"admin.content.edit":{"uri":"mw_admin\/content\/{content}\/edit","methods":["GET","HEAD"]},"admin.content.update":{"uri":"mw_admin\/content\/{content}","methods":["PUT","PATCH"]},"admin.content.destroy":{"uri":"mw_admin\/content\/{content}","methods":["DELETE"]},"admin.category.index":{"uri":"mw_admin\/category","methods":["GET","HEAD"]},"admin.category.create":{"uri":"mw_admin\/category\/create","methods":["GET","HEAD"]},"admin.category.store":{"uri":"mw_admin\/category","methods":["POST"]},"admin.category.show":{"uri":"mw_admin\/category\/{category}","methods":["GET","HEAD"]},"admin.category.edit":{"uri":"mw_admin\/category\/{category}\/edit","methods":["GET","HEAD"]},"admin.category.update":{"uri":"mw_admin\/category\/{category}","methods":["PUT","PATCH"]},"admin.category.destroy":{"uri":"mw_admin\/category\/{category}","methods":["DELETE"]},"admin.shop.category.index":{"uri":"mw_admin\/shop\/category","methods":["GET","HEAD"]},"admin.shop.category.create":{"uri":"mw_admin\/shop\/category\/create","methods":["GET","HEAD"]},"admin.shop.category.store":{"uri":"mw_admin\/shop\/category","methods":["POST"]},"admin.shop.category.show":{"uri":"mw_admin\/shop\/category\/{category}","methods":["GET","HEAD"]},"admin.shop.category.edit":{"uri":"mw_admin\/shop\/category\/{category}\/edit","methods":["GET","HEAD"]},"admin.shop.category.update":{"uri":"mw_admin\/shop\/category\/{category}","methods":["PUT","PATCH"]},"admin.shop.category.destroy":{"uri":"mw_admin\/shop\/category\/{category}","methods":["DELETE"]},"api.":{"uri":"api\/mw_reload_modules","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.category.delete":{"uri":"api\/category\/delete\/{id}","methods":["DELETE"]},"api.category.delete-bulk":{"uri":"api\/category\/delete-bulk","methods":["DELETE"]},"api.category.index":{"uri":"api\/category","methods":["GET","HEAD"]},"api.category.store":{"uri":"api\/category","methods":["POST"]},"api.category.show":{"uri":"api\/category\/{category}","methods":["GET","HEAD"]},"api.category.update":{"uri":"api\/category\/{category}","methods":["PUT","PATCH"]},"api.category.destroy":{"uri":"api\/category\/{category}","methods":["DELETE"]},"api.template.change":{"uri":"api\/template\/change","methods":["GET","HEAD"]},"api.template.compile_admin_css":{"uri":"api\/template\/compile_admin_css","methods":["GET","HEAD"]},"api.template.compile_admin_live_edit_css":{"uri":"api\/template\/compile_admin_live_edit_css","methods":["GET","HEAD"]},"api.template.get_admin_css_url":{"uri":"api\/template\/get_admin_css_url","methods":["GET","HEAD"]},"api.template.reset_admin_stylesheet":{"uri":"api\/template\/reset_admin_stylesheet","methods":["GET","HEAD"]},"api.template.reset_admin_stylesheet_colors":{"uri":"api\/template\/reset_admin_stylesheet_colors","methods":["GET","HEAD"]},"api.file-manager.list":{"uri":"api\/file-manager\/list","methods":["GET","HEAD"]},"api.file-manager.delete":{"uri":"api\/file-manager\/file","methods":["DELETE"]},"api.file-manager.create-folder":{"uri":"api\/file-manager\/create-folder","methods":["POST"]},"admin.blog.filter.get-custom-fields-table":{"uri":"mw_admin\/blog\/filter\/get-custom-fields-table","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"standalone-updater.about-new-version":{"uri":"mw_admin\/standalone-updater\/about-new-version","methods":["GET","HEAD"]},"api.standalone-updater.delete-temp":{"uri":"api\/standalone-updater\/delete-temp","methods":["GET","HEAD"]},"api.standalone-updater.update-now":{"uri":"api\/standalone-updater\/update-now","methods":["POST"]},"api.standalone-updater.remove-dashboard-notice":{"uri":"api\/standalone-updater\/remove-dashboard-notice","methods":["GET","HEAD"]},"live_edit.modules.settings.btn":{"uri":"api\/live_edit\/live_edit.modules.settings.btn","methods":["GET","HEAD"]},"api.coupon_apply":{"uri":"api\/coupon_apply","methods":["POST"]},"api.coupons_delete_session":{"uri":"api\/coupons_delete_session","methods":["POST"]},"api.coupons_save_coupon":{"uri":"api\/coupons_save_coupon","methods":["POST"]},"api.coupon_delete":{"uri":"api\/coupon_delete","methods":["POST"]},"admin.import-export-tool.upload-feed":{"uri":"mw_admin\/import-export-tool\/upload-feed","methods":["POST"]},"admin.import-export-tool.import-wizard":{"uri":"mw_admin\/import-export-tool\/import-wizard","methods":["GET","HEAD"]},"admin.import-export-tool.export-wizard":{"uri":"mw_admin\/import-export-tool\/export-wizard","methods":["GET","HEAD"]},"admin.import-export-tool.export-wizard-file":{"uri":"mw_admin\/import-export-tool\/export-wizard\/file\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.delete-wizard-file":{"uri":"mw_admin\/import-export-tool\/delete-wizard\/file\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.index.main":{"uri":"mw_admin\/import-export-tool","methods":["GET","HEAD"]},"admin.import-export-tool.install":{"uri":"mw_admin\/import-export-tool\/install","methods":["GET","HEAD"]},"admin.import-export-tool.index":{"uri":"mw_admin\/import-export-tool\/index","methods":["GET","HEAD"]},"admin.import-export-tool.import":{"uri":"mw_admin\/import-export-tool\/import\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.import-start":{"uri":"mw_admin\/import-export-tool\/import-start\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.import-delete":{"uri":"mw_admin\/import-export-tool\/import-delete\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.index-exports":{"uri":"mw_admin\/import-export-tool\/index-exports","methods":["GET","HEAD"]},"admin.shop.dashboard":{"uri":"mw_admin\/shop\/dashboard","methods":["GET","HEAD"]},"admin.shop.filter.get-custom-fields-table":{"uri":"mw_admin\/shop\/filter\/get-custom-fields-table","methods":["POST"]},"livewire.message":{"uri":"livewire\/message\/{name}","methods":["POST"]},"livewire.upload-file":{"uri":"livewire\/upload-file","methods":["POST"]},"livewire.preview-file":{"uri":"livewire\/preview-file\/{filename}","methods":["GET","HEAD"]},"login":{"uri":"login","methods":["GET","HEAD"]},"two-factor.login":{"uri":"two-factor-challenge","methods":["GET","HEAD"]},"two-factor.enable":{"uri":"user\/two-factor-authentication","methods":["POST"]},"two-factor.disable":{"uri":"user\/two-factor-authentication","methods":["DELETE"]},"two-factor.qr-code":{"uri":"user\/two-factor-qr-code","methods":["GET","HEAD"]},"two-factor.recovery-codes":{"uri":"user\/two-factor-recovery-codes","methods":["GET","HEAD"]},"api.option.save":{"uri":"api\/save_option","methods":["POST"]},"admin.language.save":{"uri":"mw_admin\/language\/save","methods":["POST"]},"admin.language.import":{"uri":"mw_admin\/language\/import","methods":["POST"]},"admin.language.export":{"uri":"mw_admin\/language\/export","methods":["POST"]},"admin.language.send_to_us":{"uri":"mw_admin\/language\/send_to_us","methods":["POST"]},"admin.language.import_missing_translations":{"uri":"mw_admin\/language\/import_missing_translations","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.page.index":{"uri":"api\/page","methods":["GET","HEAD"]},"api.page.store":{"uri":"api\/page","methods":["POST"]},"api.page.show":{"uri":"api\/page\/{page}","methods":["GET","HEAD"]},"api.page.update":{"uri":"api\/page\/{page}","methods":["PUT","PATCH"]},"api.page.destroy":{"uri":"api\/page\/{page}","methods":["DELETE"]},"admin.page.index":{"uri":"mw_admin\/page","methods":["GET","HEAD"]},"admin.page.create":{"uri":"mw_admin\/page\/create","methods":["GET","HEAD"]},"admin.page.store":{"uri":"mw_admin\/page","methods":["POST"]},"admin.page.edit":{"uri":"mw_admin\/page\/{page}\/edit","methods":["GET","HEAD"]},"admin.page.update":{"uri":"mw_admin\/page\/{page}","methods":["PUT","PATCH"]},"admin.page.destroy":{"uri":"mw_admin\/page\/{page}","methods":["DELETE"]},"api.menu.add.content":{"uri":"api\/menu\/add\/content","methods":["POST"]},"api.menu.delete":{"uri":"api\/menu\/delete","methods":["POST"]},"api.menu.create":{"uri":"api\/menu\/create","methods":["POST"]},"api.menu.item.save":{"uri":"api\/menu\/item\/save","methods":["POST"]},"api.menu.item.edit":{"uri":"api\/menu\/item\/edit","methods":["POST"]},"api.menu.item.delete":{"uri":"api\/menu\/item\/delete\/{id}","methods":["POST"]},"api.menu.item.reorder":{"uri":"api\/menu\/item\/reorder","methods":["POST"]},"api.v2.menu.index":{"uri":"api\/v2\/menu","methods":["GET","HEAD"]},"api.v2.menu.store":{"uri":"api\/v2\/menu","methods":["POST"]},"api.v2.menu.show":{"uri":"api\/v2\/menu\/{menu}","methods":["GET","HEAD"]},"api.v2.menu.update":{"uri":"api\/v2\/menu\/{menu}","methods":["PUT","PATCH"]},"api.v2.menu.destroy":{"uri":"api\/v2\/menu\/{menu}","methods":["DELETE"]},"admin.product.index":{"uri":"mw_admin\/shop\/product","methods":["GET","HEAD"]},"admin.product.create":{"uri":"mw_admin\/shop\/product\/create","methods":["GET","HEAD"]},"admin.product.store":{"uri":"mw_admin\/shop\/product","methods":["POST"]},"admin.product.edit":{"uri":"mw_admin\/shop\/product\/{product}\/edit","methods":["GET","HEAD"]},"admin.product.update":{"uri":"mw_admin\/shop\/product\/{product}","methods":["PUT","PATCH"]},"admin.product.destroy":{"uri":"mw_admin\/shop\/product\/{product}","methods":["DELETE"]},"api.product.quick-view":{"uri":"api\/product\/quick-view","methods":["GET","HEAD"]},"api.product.index":{"uri":"api\/product","methods":["GET","HEAD"]},"api.product.store":{"uri":"api\/product","methods":["POST"]},"api.product.show":{"uri":"api\/product\/{product}","methods":["GET","HEAD"]},"api.product.update":{"uri":"api\/product\/{product}","methods":["PUT","PATCH"]},"api.product.destroy":{"uri":"api\/product\/{product}","methods":["DELETE"]},"api.product_variant.index":{"uri":"api\/product_variant","methods":["GET","HEAD"]},"api.product_variant.store":{"uri":"api\/product_variant","methods":["POST"]},"api.product_variant.show":{"uri":"api\/product_variant\/{product_variant}","methods":["GET","HEAD"]},"api.product_variant.update":{"uri":"api\/product_variant\/{product_variant}","methods":["PUT","PATCH"]},"api.product_variant.destroy":{"uri":"api\/product_variant\/{product_variant}","methods":["DELETE"]},"api.post.index":{"uri":"api\/post","methods":["GET","HEAD"]},"api.post.store":{"uri":"api\/post","methods":["POST"]},"api.post.show":{"uri":"api\/post\/{post}","methods":["GET","HEAD"]},"api.post.update":{"uri":"api\/post\/{post}","methods":["PUT","PATCH"]},"api.post.destroy":{"uri":"api\/post\/{post}","methods":["DELETE"]},"admin.post.index":{"uri":"mw_admin\/post","methods":["GET","HEAD"]},"admin.post.create":{"uri":"mw_admin\/post\/create","methods":["GET","HEAD"]},"api.comment.post":{"uri":"mw_admin\/post","methods":["POST"]},"admin.post.edit":{"uri":"mw_admin\/post\/{post}\/edit","methods":["GET","HEAD"]},"admin.post.update":{"uri":"mw_admin\/post\/{post}","methods":["PUT","PATCH"]},"admin.post.destroy":{"uri":"mw_admin\/post\/{post}","methods":["DELETE"]},"admin.live-edit.index":{"uri":"mw_admin\/live-edit","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"admin.order.abandoned":{"uri":"mw_admin\/order\/abandoned","methods":["GET","HEAD"]},"admin.order.index":{"uri":"mw_admin\/order","methods":["GET","HEAD"]},"admin.order.show":{"uri":"mw_admin\/order\/{order}","methods":["GET","HEAD"]},"api.order.index":{"uri":"api\/order","methods":["GET","HEAD"]},"api.order.store":{"uri":"api\/order","methods":["POST"]},"api.order.show":{"uri":"api\/order\/{order}","methods":["GET","HEAD"]},"api.order.update":{"uri":"api\/order\/{order}","methods":["PUT","PATCH"]},"api.order.destroy":{"uri":"api\/order\/{order}","methods":["DELETE"]},"checkout.cart":{"uri":"checkout\/cart","methods":["GET","HEAD"]},"checkout.contact_information":{"uri":"checkout\/contact-information","methods":["GET","HEAD"]},"checkout.contact_information_save":{"uri":"checkout\/contact-information-save","methods":["POST"]},"checkout.shipping_method":{"uri":"checkout\/shipping-method","methods":["GET","HEAD"]},"checkout.shipping_method_change":{"uri":"checkout\/shipping-method-change","methods":["POST"]},"checkout.shipping_method_save":{"uri":"checkout\/shipping-method-save","methods":["POST"]},"checkout.payment_method":{"uri":"checkout\/payment-method","methods":["GET","HEAD"]},"checkout.payment_method_change":{"uri":"checkout\/payment-method-change","methods":["POST"]},"checkout.payment_method_save":{"uri":"checkout\/payment-method-save","methods":["POST"]},"checkout.login":{"uri":"checkout\/login","methods":["GET","HEAD"]},"checkout.forgot_password":{"uri":"checkout\/forgot-password","methods":["GET","HEAD"]},"checkout.register":{"uri":"checkout\/register","methods":["GET","HEAD"]},"checkout.finish":{"uri":"checkout\/finish\/{id}","methods":["GET","HEAD"]},"api.checkout.":{"uri":"api\/checkout\/validate","methods":["POST"]},"shop.shipping.set_provider":{"uri":"api\/shop\/shipping\/set_provider","methods":["GET","POST","HEAD"]},"api.offer.store":{"uri":"api\/offer_save","methods":["POST"]},"api.offer.delete":{"uri":"api\/offer_delete","methods":["POST"]},"api.offer.get_all":{"uri":"api\/offers_get_all","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.post.form":{"uri":"api\/post_form","methods":["POST"]},"admin.backup.restore":{"uri":"mw_admin\/backup\/restore","methods":["GET","HEAD"]},"admin.backup.start":{"uri":"mw_admin\/backup\/start","methods":["GET","HEAD"]},"admin.backup.download":{"uri":"mw_admin\/backup\/download","methods":["GET","HEAD"]},"admin.backup.generate-session-id":{"uri":"mw_admin\/backup\/generate-session-id","methods":["GET","HEAD"]},"admin.backup.upload":{"uri":"mw_admin\/backup\/upload","methods":["POST"]},"admin.backup.delete":{"uri":"mw_admin\/backup\/delete","methods":["POST"]},"admin.backup.language.export":{"uri":"mw_admin\/backup\/language\/export","methods":["POST"]},"admin.backup.language.upload":{"uri":"mw_admin\/backup\/language\/upload","methods":["POST"]},"admin.customers.delete":{"uri":"mw_admin\/customers\/delete","methods":["POST"]},"admin.customers.index":{"uri":"mw_admin\/customers","methods":["GET","HEAD"]},"admin.customers.create":{"uri":"mw_admin\/customers\/create","methods":["GET","HEAD"]},"admin.customers.store":{"uri":"mw_admin\/customers","methods":["POST"]},"admin.customers.show":{"uri":"mw_admin\/customers\/{customer}","methods":["GET","HEAD"]},"admin.customers.edit":{"uri":"mw_admin\/customers\/{customer}\/edit","methods":["GET","HEAD"]},"admin.customers.update":{"uri":"mw_admin\/customers\/{customer}","methods":["PUT","PATCH"]},"admin.customers.destroy":{"uri":"mw_admin\/customers\/{customer}","methods":["DELETE"]},"admin.notification.read":{"uri":"mw_admin\/notification\/read","methods":["POST"]},"admin.notification.reset":{"uri":"mw_admin\/notification\/reset","methods":["POST"]},"admin.notification.delete":{"uri":"mw_admin\/notification\/delete","methods":["POST"]},"admin.notification.test_mail":{"uri":"mw_admin\/notification\/test_mail","methods":["POST"]},"admin.notification.index":{"uri":"mw_admin\/notification","methods":["GET","HEAD"]},"api.comment.admin.edit":{"uri":"mw_admin\/edit","methods":["POST"]},"admin.comment.comment.index":{"uri":"mw_admin\/comment","methods":["GET","HEAD"]},"api.multilanguage.geolocaiton_test":{"uri":"api\/multilanguage\/geolocaiton_test","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.multilanguage.change_language":{"uri":"api\/multilanguage\/change_language","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"admin.multilanguage.index":{"uri":"mw_admin\/multilanguage","methods":["GET","HEAD"]},"api.module.list":{"uri":"api\/module\/list","methods":["GET","HEAD"]},"debugbar.openhandler":{"uri":"_debugbar\/open","methods":["GET","HEAD"]},"debugbar.clockwork":{"uri":"_debugbar\/clockwork\/{id}","methods":["GET","HEAD"]},"debugbar.assets.css":{"uri":"_debugbar\/assets\/stylesheets","methods":["GET","HEAD"]},"debugbar.assets.js":{"uri":"_debugbar\/assets\/javascript","methods":["GET","HEAD"]},"debugbar.cache.delete":{"uri":"_debugbar\/cache\/{key}\/{tags?}","methods":["DELETE"]},"filament.asset":{"uri":"filament\/assets\/{file}","methods":["GET","HEAD"],"wheres":{"file":".*"}},"filament.auth.logout":{"uri":"filament\/logout","methods":["POST"]},"filament.auth.login":{"uri":"mw_admin\/v2\/login","methods":["GET","HEAD"]},"filament.pages.dashboard":{"uri":"mw_admin\/v2","methods":["GET","HEAD"]},"filament.pages.profile":{"uri":"mw_admin\/v2\/profile","methods":["GET","HEAD"]},"filament.resources.microweber-packages\/module\/modules.index":{"uri":"mw_admin\/v2\/microweber-packages\/module\/modules","methods":["GET","HEAD"]},"filament.resources.users.index":{"uri":"mw_admin\/v2\/users","methods":["GET","HEAD"]},"api.save_mail_template":{"uri":"api\/save_mail_template","methods":["POST"]},"api.delete_mail_template":{"uri":"api\/delete_mail_template","methods":["POST"]},"adminadmin.index":{"uri":"mw_admin","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"editor_tools":{"uri":"editor_tools\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"adminadmin.all":{"uri":"mw_admin\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"clani":{"uri":"clani","methods":["GET","HEAD"]},"knjige":{"uri":"knjige","methods":["GET","HEAD"]},"apijs":{"uri":"apijs\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"csrf-validate-token":{"uri":"csrf-validate-token","methods":["POST"]},"csrf":{"uri":"csrf","methods":["POST"]},"module":{"uri":"module\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"api":{"uri":"api\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"api_html":{"uri":"api_html\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"apiapi_nosession.all":{"uri":"api_nosession\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"api_nosession":{"uri":"api_nosession","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"home":{"uri":"\/","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"robots":{"uri":"robots.txt","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"sitemap.index":{"uri":"sitemap.xml","methods":["GET","HEAD"]},"sitemap.categories":{"uri":"sitemap.xml\/categories","methods":["GET","HEAD"]},"sitemap.tags":{"uri":"sitemap.xml\/tags","methods":["GET","HEAD"]},"sitemap.products":{"uri":"sitemap.xml\/products","methods":["GET","HEAD"]},"sitemap.posts":{"uri":"sitemap.xml\/posts","methods":["GET","HEAD"]},"sitemap.pages":{"uri":"sitemap.xml\/pages","methods":["GET","HEAD"]},"rss.index":{"uri":"rss","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"rss.products":{"uri":"rss-products","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"rss.posts":{"uri":"rss-posts","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"all":{"uri":"{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"passport.token":{"uri":"oauth\/token","methods":["POST"]},"passport.token.refresh":{"uri":"oauth\/token\/refresh","methods":["POST"]},"passport.authorizations.authorize":{"uri":"oauth\/authorize","methods":["GET","HEAD"]},"passport.authorizations.approve":{"uri":"oauth\/authorize","methods":["POST"]},"passport.authorizations.deny":{"uri":"oauth\/authorize","methods":["DELETE"]},"passport.tokens.index":{"uri":"oauth\/tokens","methods":["GET","HEAD"]},"passport.tokens.destroy":{"uri":"oauth\/tokens\/{token_id}","methods":["DELETE"]},"passport.clients.index":{"uri":"oauth\/clients","methods":["GET","HEAD"]},"passport.clients.store":{"uri":"oauth\/clients","methods":["POST"]},"passport.clients.update":{"uri":"oauth\/clients\/{client_id}","methods":["PUT"]},"passport.clients.destroy":{"uri":"oauth\/clients\/{client_id}","methods":["DELETE"]},"passport.scopes.index":{"uri":"oauth\/scopes","methods":["GET","HEAD"]},"passport.personal.tokens.index":{"uri":"oauth\/personal-access-tokens","methods":["GET","HEAD"]},"passport.personal.tokens.store":{"uri":"oauth\/personal-access-tokens","methods":["POST"]},"passport.personal.tokens.destroy":{"uri":"oauth\/personal-access-tokens\/{token_id}","methods":["DELETE"]}}};
