...
<?php else: ?>
    ...
    <div id="user_login_holder_<?php print $params['id'] ?>">
        ...
        <p><?php _lang("Če že imate ustvarjen račun" , "templates/new-world"); ?> <br/><?php _lang("se prijavite spodaj." , "templates/new-world"); ?><br/><br/></p>
        ...
        <form method="post" id="user_login_<?php print $params['id'] ?>" action="#" autocomplete="off">
            ...
            <div class="form-group">
                <input class="form-control input-lg" type="text" name="username" placeholder="<?php _lang("E-mail" , "templates/new-world"); ?>">
            </div>

            <div class="form-group m-t-20">
                <input class="form-control input-lg" type="password" name="password" placeholder="<?php _lang("Geslo" , "templates/new-world"); ?>">
            </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        <label class="styled-checkbox"><?php _lang("Zapomni si me" , "templates/new-world"); ?>
                ...
                <div class="col-12 col-lg-6">
                    <p><a href="<?php print forgot_password_url(); ?>"><?php _lang("Pozabljeno geslo ?" , "templates/new-world"); ?></a></p>
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-default btn-lg btn-block m-t-10"><?php _lang("Prijava" , "templates/new-world"); ?></button>
        </form>
        ...
        <p class="or"><span>ali</span></p>

        <div class="act create">
            <a href="<?php print register_url(); ?>" class="js-show-register-window"><span><?php _lang("Postanite član!" , "templates/new-world"); ?></span></a>
        </div>
    </div>
<?php endif; ?>
